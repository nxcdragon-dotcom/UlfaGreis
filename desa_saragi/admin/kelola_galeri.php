<?php
/**
 * Desa Saragi - Kelola Galeri (Manage Gallery)
 * List all gallery photos with edit and delete functionality
 */
session_start();
...
try {
    $stmt = $conn->prepare("SELECT id, judul, gambar, tanggal FROM gallery ORDER BY tanggal DESC");
    $stmt->execute();
        ...
        <aside class="w-64 bg-gray-900 text-gray-100 min-h-screen p-6 hidden md:block">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="kelola_berita.php" class="hover:text-emerald-400 transition">📋 Kelola Berita</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="kelola_galeri.php" class="text-emerald-300 font-semibold">📋 Kelola Galeri</a></li>
                    ...
                    <div class="bg-gray-50 rounded-lg overflow-hidden hover:shadow-lg transition">
                        ...
                        <div class="relative h-48 bg-gray-200 overflow-hidden">
                            <?php if (!empty($gallery['gambar'])): ?>
                                <img src="../uploads/<?php echo htmlspecialchars($gallery['gambar']); ?>" alt="<?php echo htmlspecialchars($gallery['judul']); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                        ...
                        <div class="p-4">
                            <h3 class="font-semibold text-gray-800 mb-2">
                                <?php echo htmlspecialchars(substr($gallery['judul'], 0, 50)); ?>
                            </h3>
