<?php
/**
 * Desa Saragi - Kelola Pejabat (Manage Officials)
 * List all officials with edit and delete functionality
 */
session_start();
...
// Fetch all officials
try {
    $stmt = $conn->prepare("SELECT id, nama, posisi, kontak FROM officials ORDER BY posisi ASC");
    $stmt->execute();
    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-gray-900 text-gray-100 min-h-screen p-6 hidden md:block">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="kelola_pejabat.php" class="text-emerald-300 font-semibold">📋 Kelola Pejabat</a></li>
        ...
        <main class="flex-1 p-6">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">Kelola semua data pejabat desa</p>
            </div>
                    ...
                    <table class="w-full border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-gray-600">
                                    <?php echo htmlspecialchars($official['kontak']); ?>
                                </td>
